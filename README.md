...
![ER injuries app in its original form showing a dropdown box top left from which the user can choose the type of product that cause the injury, and a drop down list top right that allows you to toggle the Y-axis between count and rate. Three summary tables below this summarise the top 5 most frequent diagnoses, body parts affected and locations where the injury happened. Below that is a graph brekaing down the frequency of the injury against patient age, and split according to sex.]([http://url/to/img.png](https://github.com/PlantsGenesBugs/ER_injuries/blob/main/orig_app_screenshot.png))  
